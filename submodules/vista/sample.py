...
if __name__ == "__main__":
    ...
    while sample_index >= 0:
        ...
        if isinstance(out, (tuple, list)):
            ...
            virtual_path = os.path.join(opt.save, "virtual", str(sample_index))
            real_path = os.path.join(opt.save, "real", str(sample_index))
            ...
            perform_save_locally(virtual_path, feats, "feats", opt.dataset, sample_index)
